 ...
 * @param {Response} res - Express response object use to send error responses if authentication fails
 * @param {NextFunction} next - Express next funtion to pass control to next middleware.
 *
 * @returns {void}
 */
const authenticate = (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    // Process the next middleware or route handler
    return next();
  } catch (err) {
